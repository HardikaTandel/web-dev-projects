...
const API_key = "0b6fe575b55664558a086b11935224ec";

const createWeatherCard = (cityName, weatherItem, index) => {
    if (index === 0) {
        return `  <div class="details">
 <h2>${cityName} (${weatherItem.dt_txt.split(" ")[0]})</h2>
 <h4>Temperature: ${(weatherItem.main.temp - 273.15).toFixed(2)}&#8451</h4>
...
<div class="icon">
 ...
 <h4>${weatherItem.weather[0].description} </h4>
    ...
    <h4>Temp: ${(weatherItem.main.temp - 273.15).toFixed(2)}&#8451</h4>
    <h4>Wind: ${weatherItem.wind.speed} M/S</h4>
    <h4>Humidity: ${weatherItem.main.humidity}%</h4>
</li>`
    }
...
getCityCoordinates = () => {
    ...
    fetch(GEOCODING_API_URL).then(res => res.json())
        .then(data => {
            if (!data.length) {
                return alert(`No coordinates found ${cityName}`);
            }
